...
def build_system_map():
    ...
    nodes = [
        ...
        {
            "id": "InterHospSpread",
            "label": "Inter-hospital spread",
            "layer": "macro",
            "category": "outcome",
        },
        {
            "id": "ColonPressure",
            "label": "Colonization pressure",
            "layer": "macro",
            "category": "state",
        },
        {
        ...
        {
            "id": "TreatFailure",
            "label": "Treatment failure risk",
            "layer": "macro",
            "category": "outcome",
        },
        {
            "id": "InfectDuration",
            "label": "Infection/colonization duration",
            "layer": "macro",
            "category": "state",
        },
        ...
        {
            "id": "WithinHost",
            "label": "Within-host evolution",
            "layer": "micro",
            "category": "process",
        },
        {
            "id": "SelPressure",
            "label": "Selection pressure (antibiotics)",
            "layer": "micro",
            "category": "mechanism",
        },
        ...
        {
            "id": "FitnessCost",
            "label": "Fitness cost (no antibiotics)",
            "layer": "micro",
            "category": "mechanism",
        },
        {
            "id": "TransFitness",
            "label": "Transmission fitness",
            "layer": "micro",
            "category": "state",
        },
    ]
